...
Univerisities</router-link></li>
                    <li class="text-lg link"><router-link to="/institution/opportunities/" class="flex items-center gap-2">
                        <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
Opportunies</router-link></li>
                    <li class="text-lg link"><router-link to="/institution/applications/" class="flex items-center gap-2">
                        <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
Applications</router-link></li>
                    ...
                    <li class="text-lg link"><router-link to="/institution/profile/" class="flex items-center gap-2">
                        <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
