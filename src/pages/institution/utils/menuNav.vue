<template>
    <div class="bg-gray-200 border-r border-gray-400 h-[100vh] flex flex-col items-center pt-4 sticky top-0 mobile-menu">
            ...
            <div class="md:block w-full p-4">
                <ul class="flex flex-col gap-2">
                    <li class="text-lg link"><router-link to="/institution/dashboard/" class="flex items-center gap-2">
  ...
  <path d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <li class="text-lg link"><router-link to="/institution/employees/" class="flex items-center gap-2">
