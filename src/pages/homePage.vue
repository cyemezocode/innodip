        ...
        <div class="max-w-screen-lg mx-auto px-3 md:px-0 py-4 justify-center mt-[-100px]">
            ...
            <div class="front"  ref="myElement">
                ...
                <router-link to="#" class="card-hover dark h-44 flex flex-col justify-between items-center">
                    ...
                    <h1 class="text-xl text-gray-500">Curriculums</h1>
                </router-link>
                <router-link to="#" class="card-hover dark h-44 flex flex-col justify-between items-center">
                    ...
                    <h1 class="text-xl text-gray-500">Internerships</h1>
                </router-link>
                <router-link to="#" class="card-hover dark h-44 flex flex-col justify-between items-center">
                    <svg class="w-16 h-16 text-secondary" fill="#000000" viewBox="0 0 24 24" id="job" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="secondary" d="M16,8H8A1,1,0,0,1,7,7V4A2,2,0,0,1,9,2h6a2,2,0,0,1,2,2V7A1,1,0,0,1,16,8ZM9,6h6V4H9Z" style="fill: #2ca9bc;"></path><rect id="primary" x="2" y="6" width="20" height="16" rx="2" style="fill: #000000;"></rect><path id="secondary-2" data-name="secondary" d="M15,14a1,1,0,0,1-1-1V12H7a1,1,0,0,1,0-2H17a1,1,0,0,1,0,2H16v1A1,1,0,0,1,15,14Z" style="fill: #2ca9bc;"></path></g></svg>
                    <h1 class="text-xl text-gray-500">Part-time Jobs</h1>
                </router-link>
                <router-link to="#" class="card-hover dark h-44 flex flex-col justify-between items-center">
                    ...
                    <h1 class="text-xl text-gray-500">Full-time Jobs</h1>
                </router-link>
                <router-link to="#" class="card-hover dark h-44 flex flex-col justify-between items-center">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-2 md:grid-cols-6 rounded-xl border border-slate-700 overflow-hidden mb-4 relative">
                    <router-link to="" v-for="ind in datas.universities" :key="ind.id" class="card-hover dark2 h-44 flex flex-col justify-between items-center">
                        <img :src="ind.logo" :alt="ind.name" class="w-full px-4">
            ...
            <div class="flex w-full items-center gap-4 mb-3">
                ...
                <path d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" stroke-linecap="round" stroke-linejoin="round"></path>
                 ...
                 <h1 class="text-3xl text-gray-500">Explore Categories</h1>
            </div>
            <div class="flex gap-2 flex-wrap  overflow-hidden mb-4">
                <router-link to="" v-for="ind in datas.categories" :key="ind.id" class="card-hover dark3 flex flex-col justify-between items-center">
