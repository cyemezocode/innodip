<template>
    <div class="card-secondary p-0 grid grid-cols-1 relative">
        <div class="w-full bg-gray-700 relative h-24 flex border-b border-gray-300">
            <span class="md:absolute top-3 right-3 border border-1 px-2 py-1 rounded-lg bg-gray-400 text-white">{{ job.category }}</span>
            <h1 class="col-span-2 flex absolute left-1/2 top-5 translate-x-[-50%] p-1 opacity-[.8] rounded-lg bg-gray-600 text-white z-10">{{ job.name }}</h1>
        ...
        <div class="w-full col-span-8 p-3 pt-10 h-42">
            <h2 class="text-sm text-gray-500 flex items-center">
