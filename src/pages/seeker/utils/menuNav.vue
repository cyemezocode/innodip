<template>
  ...
  >
    ...
    /></router-link>
    <div class="md:block w-full p-4 overflow-x-auto">
      <ul class="flex flex-col gap-2">
        <li class="text-lg link">
          <router-link to="/seeker/dashboard/" class="flex items-center gap-2">
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="none"
        ...
        <li class="text-lg link">
          <router-link to="/seeker/industries/" class="flex items-center gap-2">
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="none"
        ...
        <li class="text-lg link">
          <router-link to="/seeker/resume/" class="flex items-center gap-2">
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="none"
        ...
        <li class="text-lg link">
          <router-link to="/seeker/interest/" class="flex items-center gap-2">
            <svg
              class="w-6 h-6"
              aria-hidden="true"
              fill="none"
