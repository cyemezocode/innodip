  ...
  <div class="block md:flex relative">
    ...
    <div class="w-[100%] md:w-[80%]">
      ...
      <div class="p-4">
        <div class="">
          <div
            class="w-full flex flex-col-reverse md:flex-row gap-4 card relative"
            v-if="isLoaded"
          >
            <span
              class="md:absolute top-4 right-4 border border-1 px-4 py-3 rounded-lg bg-secondary text-white"
              >Status: {{ jobData.status }}</span
            >
            <!-- {{ jobData.provider }} -->
